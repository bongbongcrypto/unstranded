...
export const SEGMENT_SLOTS = [
  ...
  { id: "f", from: "01:59.100", to: "02:14.100", what: "waiting unattended, and what is unfinished" },
  { id: "g", from: "02:14.100", to: "02:41.100", what: "the three that were in KeeperHub, and the close" },
];
