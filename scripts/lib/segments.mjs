...
export const SEGMENT_SLOTS = [
  ...
  { id: "d", from: "01:14.600", to: "01:36.300", what: "a stranger's five ether released, and the balance that moved" },
  { id: "e", from: "01:36.300", to: "02:00.600", what: "both refusals, and the gate that was missing at first" },
  { id: "f", from: "02:00.600", to: "02:14.400", what: "waiting unattended, and what is unfinished" },
  { id: "g", from: "02:14.400", to: "02:41.400", what: "the three that were in KeeperHub, and the close" },
];
