...
apart. The account that made the release below holds exactly
`on-demand-finalizer.json` with its one placeholder filled in, and
`scripts/check-live.mjs` is what compares the two.
